...
ShootNoteFromIntakeCommand::ShootNoteFromIntakeCommand(IntakeSubsystem *intakeSubsystem, units::revolutions_per_minute_t intakeOutputSpeed, ShooterSubsystem *shooterSubsystem, units::revolutions_per_minute_t leftTargetSpeed, units::revolutions_per_minute_t rightTargetSpeed, units::second_t shooterSpinUpTimeout, units::second_t launchTimeout)
{
   ...
   this->SetName("ShootNoteFromIntakeCommand()");
...
void ShootNoteFromIntakeCommand::Initialize()
{
...
void ShootNoteFromIntakeCommand::Execute()
{
...
void ShootNoteFromIntakeCommand::End(bool interrupted)
{
...
bool ShootNoteFromIntakeCommand::IsFinished()
{
