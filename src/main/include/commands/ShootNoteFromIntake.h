 ...
 */
class ShootNoteFromIntake : public frc2::CommandHelper<frc2::Command, ShootNoteFromIntake>
{
 public:
  ShootNoteFromIntake(IntakeSubsystem *intakeSubsystem, units::revolutions_per_minute_t intakeOutputSpeed, ShooterSubsystem *shooterSubsystem, units::revolutions_per_minute_t leftTargetSpeed, units::revolutions_per_minute_t rightTargetSpeed, units::second_t shooterSpinUpTimeout, units::second_t launchTimeout);
